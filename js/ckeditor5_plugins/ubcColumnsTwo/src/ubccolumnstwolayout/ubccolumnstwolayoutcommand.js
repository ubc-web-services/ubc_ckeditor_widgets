/**
 * @file defines UbcColumnsTwoLayoutCommand.
 */
 ...
 */
export default class UbcColumnsTwoLayoutCommand extends Command {
  /**
   * Creates a new `UbcColumnsTwoLayoutCommand` instance.
   *
