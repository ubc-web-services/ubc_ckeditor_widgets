...
function createUbcColumnsTwo(writer) {
  ...
  const firstColumn = writer.createElement('ubcColumnsTwoColumn', { class: 'widget-region-one' });
  const secondColumn = writer.createElement('ubcColumnsTwoColumn', { class: 'widget-region-Two' });
