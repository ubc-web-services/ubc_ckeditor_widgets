/**
 * @file defines UbcColumnsTwoPaddingCommand.
 */
 ...
 */
export default class UbcColumnsTwoPaddingCommand extends Command {
  /**
   * Creates a new `UbcColumnsTwoPaddingCommand` instance.
   *
