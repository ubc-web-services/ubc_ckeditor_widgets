...
import UbcCardVerticalOneShadowCommand from './ubccardverticaloneshadowcommand';

export default class UbcCardVerticalOneShadowEditing extends Plugin {
  ...
  static get pluginName() {
    return 'UbcCardVerticalOneShadowEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcCardVerticalOneShadowCommand(editor)
    );
  }
