...
import UbcCardVerticalOneBackgroundCommand from './ubccardverticalonebackgroundcommand';

export default class UbcCardVerticalOneBackgroundEditing extends Plugin {
  ...
  static get pluginName() {
    return 'UbcCardVerticalOneBackgroundEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcCardVerticalOneBackgroundCommand(editor)
    );
  }
