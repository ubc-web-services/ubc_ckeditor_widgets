 ...
 */
export default class UbcCardVerticalOneBackgroundCommand extends Command {
  /**
   * Creates a new `UbcCardVerticalOneBackgroundCommand` instance.
   *
  ...
  execute(options = {}) {
    ...
    // Is the command triggered from the `ubcCardVerticalOne`?
