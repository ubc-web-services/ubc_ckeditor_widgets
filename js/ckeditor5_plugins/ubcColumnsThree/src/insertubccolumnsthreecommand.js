/**
 * @file defines InsertUbcColumnsThreeCommand, which is executed when the ubcColumnsThree
...
export default class InsertUbcColumnsThreeCommand extends Command {
  execute() {
...
function createUbcColumnsThree(writer) {
  ...
  const ubcColumnsThree = writer.createElement('ubcColumnsThree');
  const firstColumn = writer.createElement('ubcColumnsThreeColumn', { class: 'widget-region-one' });
  const secondColumn = writer.createElement('ubcColumnsThreeColumn', { class: 'widget-region-two' });
  const thirdColumn = writer.createElement('ubcColumnsThreeColumn', { class: 'widget-region-three' });
  const wrapper = writer.createElement('ubcColumnsThreeWrapper');
