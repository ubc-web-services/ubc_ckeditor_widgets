/**
 * @file defines UbcColumnsThreeMarginCommand.
 */
 ...
 */
export default class UbcColumnsThreeMarginCommand extends Command {
  /**
   * Creates a new `UbcColumnsThreeMarginCommand` instance.
   *
