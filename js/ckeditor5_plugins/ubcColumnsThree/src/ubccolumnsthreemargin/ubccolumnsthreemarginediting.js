...
import UbcColumnsThreeMarginCommand from './ubccolumnsthreemargincommand';

export default class UbcColumnsThreeMarginEditing extends Plugin {
  static get requires() {
    return [Widget];
  }

  static get pluginName() {
    return 'UbcColumnsThreeMarginEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcColumnsThreeMarginCommand(editor)
    );
  }
