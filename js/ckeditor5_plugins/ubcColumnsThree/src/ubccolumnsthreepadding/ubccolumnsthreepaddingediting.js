...
import UbcColumnsThreePaddingCommand from './ubccolumnsthreepaddingcommand';

export default class UbcColumnsThreePaddingEditing extends Plugin {
  ...
  static get pluginName() {
    return 'UbcColumnsThreePaddingEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcColumnsThreePaddingCommand(editor)
    );
  }
