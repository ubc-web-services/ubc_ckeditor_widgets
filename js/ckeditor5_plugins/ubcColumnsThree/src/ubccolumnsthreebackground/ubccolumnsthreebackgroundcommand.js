/**
 * @file defines UbcColumnsThreeBackgroundCommand.
 */
 ...
 */
export default class UbcColumnsThreeBackgroundCommand extends Command {
  /**
   * Creates a new `UbcColumnsThreeBackgroundCommand` instance.
   *
