/**
 * @file defines UbcCardVerticalThreeGapCommand.
 */
 ...
 */
export default class UbcCardVerticalThreeGapCommand extends Command {
  /**
   * Creates a new `UbcCardVerticalThreeGapCommand` instance.
   *
