/**
 * @file defines UbcCardVerticalThreeBackgroundCommand.
 */
 ...
 */
export default class UbcCardVerticalThreeBackgroundCommand extends Command {
  /**
   * Creates a new `UbcCardVerticalThreeBackgroundCommand` instance.
   *
  ...
  execute(options = {}) {
    ...
    // Is the command triggered from the `ubcCardVerticalThree`?
