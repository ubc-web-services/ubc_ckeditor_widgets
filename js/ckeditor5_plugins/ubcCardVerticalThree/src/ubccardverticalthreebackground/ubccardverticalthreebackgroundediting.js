...
import UbcCardVerticalThreeBackgroundCommand from './ubccardverticalthreebackgroundcommand';

export default class UbcCardVerticalThreeBackgroundEditing extends Plugin {
  ...
  static get pluginName() {
    return 'UbcCardVerticalThreeBackgroundEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcCardVerticalThreeBackgroundCommand(editor)
    );
  }
