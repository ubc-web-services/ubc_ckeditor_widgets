/**
 * @file defines UbcCardVerticalThreeMarginCommand.
 */
 ...
 */
export default class UbcCardVerticalThreeMarginCommand extends Command {
  /**
   * Creates a new `UbcCardVerticalThreeMarginCommand` instance.
   *
