/**
 * @file defines UbcCardVerticalThreeCommand, which is executed when the ubcCardVerticalThree
...
export default class UbcCardVerticalThreeCommand extends Command {
  ...
  execute() {
    ...
    if (selectedElement && selectedElement.is('element', 'ubcCardVerticalThree')) {
      ...
      modelColorBox = selection.getFirstPosition().findAncestor('ubcCardVerticalThree');
    }
...
function createUbcCardVerticalThree(writer) {
  ...
  const firstImage = writer.createElement('ubcCardVerticalThreeImage', {
    class: 'first-image'
  });
  const firstImagePlaceholder = writer.createElement('imageInline', {
    src: 'https://placehold.co/700x350'
  });
  const firstContent = writer.createElement('ubcCardVerticalThreeContent', {
    class: 'first-content'
  });
  ...
  const firstFooter = writer.createElement('ubcCardVerticalThreeFooter', {
    class: 'first-footer'
  });
  ...
  const secondImage = writer.createElement('ubcCardVerticalThreeImage', {
    class: 'second-image'
  });
  const secondImagePlaceholder = writer.createElement('imageInline', {
    src: 'https://placehold.co/700x350'
  });
  const secondContent = writer.createElement('ubcCardVerticalThreeContent', {
  ...
  const secondFooter = writer.createElement('ubcCardVerticalThreeFooter', {
    class: 'second-footer'
  });
  ...
  const thirdImage = writer.createElement('ubcCardVerticalThreeImage', {
    class: 'third-image'
  });
  const thirdImagePlaceholder = writer.createElement('imageInline', {
    src: 'https://placehold.co/700x350'
  });
  const thirdContent = writer.createElement('ubcCardVerticalThreeContent', {
    class: 'third-content'
  });
  const thirdContentHeading = writer.createElement('heading3', {
    class: 'card__title'
  });
  const thirdContentParagraph = writer.createElement('paragraph');
  const thirdFooter = writer.createElement('ubcCardVerticalThreeFooter', {
    class: 'third-footer'
  });
  const thirdFooterParagraph = writer.createElement('paragraph');
  const thirdFooterLink = writer.createText('Learn more', {
    linkHref: '/'
  });
