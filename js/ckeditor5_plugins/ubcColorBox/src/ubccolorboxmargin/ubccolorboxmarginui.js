...
export default class UbcColorBoxMarginUI extends Plugin {

  /**
   * @inheritDoc
   */
  static get pluginName() {
    return 'UbcColorBoxMarginUI';
  }
  ...
  init() {
    ...
    const command = editor.commands.get('ubcColorBoxMargin');

    editor.ui.componentFactory.add('ubcColorBoxMarginOptions', locale => {
...
function _prepareListOptions(options, command) {
  ...
  const activecommand = 'ubcColorBoxMargin';
  let alloptions = marginStyles.map(style => {
    return style;
  });
