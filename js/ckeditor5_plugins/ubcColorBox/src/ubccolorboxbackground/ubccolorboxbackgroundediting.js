...
import UbcColorBoxBackgroundCommand from './ubccolorboxbackgroundcommand';

export default class UbcColorBoxBackgroundEditing extends Plugin {
  ...
  static get pluginName() {
    return 'UbcColorBoxBackgroundEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcColorBoxBackgroundCommand(editor)
    );
  }
