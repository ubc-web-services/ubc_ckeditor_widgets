...
import InsertUbcTableCellClassCommand from './insertubctablecellclasscommand';
...
export default class UbcTableCellClassEditing extends Plugin {
  ...
  init() {
    ...
    const table_classes = [
      { id: 'half', classes: 'w-half' },
      { id: 'third', classes: 'w-one-third' },
      { id: 'quarter', classes: 'w-one-quarter' },
      { id: 'fifth', classes: 'w-one-fifth' },
      { id: 'sixth', classes: 'w-one-sixth' },
    ];
    ...
    editor.commands.add( 'setCellClass1', new InsertUbcTableCellClassCommand( editor, 'half' ) );
    editor.commands.add( 'setCellClass2', new InsertUbcTableCellClassCommand( editor, 'third' ) );
    editor.commands.add( 'setCellClass3', new InsertUbcTableCellClassCommand( editor, 'quarter' ) );
    editor.commands.add( 'setCellClass4', new InsertUbcTableCellClassCommand( editor, 'fifth' ) );
    editor.commands.add( 'setCellClass5', new InsertUbcTableCellClassCommand( editor, 'sixth' ) );

    table_classes.forEach( ( tableClass ) => {
      editor.model.schema.extend( 'tableCell', { allowAttributes: tableClass.id } );
