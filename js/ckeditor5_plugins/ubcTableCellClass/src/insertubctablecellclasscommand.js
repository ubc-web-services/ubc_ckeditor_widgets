/**
 * @file defines InsertUbcTableCellClassCommand, which is executed when the ubcAccordionToggle
...
export default class InsertUbcTableCellClassCommand extends Command {
