...
import UbcCardVerticalTwoBackgroundCommand from './ubccardverticaltwobackgroundcommand';

export default class UbcCardVerticalTwoBackgroundEditing extends Plugin {
  ...
  static get pluginName() {
    return 'UbcCardVerticalTwoBackgroundEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcCardVerticalTwoBackgroundCommand(editor)
    );
  }
