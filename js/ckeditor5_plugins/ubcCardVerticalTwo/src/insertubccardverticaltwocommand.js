/**
 * @file defines InsertUbcCardVerticalTwoCommand, which is executed when the ubcCardVerticalTwo
 * toolbar button is pressed.
 */

import { Command } from 'ckeditor5/src/core';

export default class InsertUbcCardVerticalTwoCommand extends Command {
  execute() {
...
function createUbcCardVerticalTwo(writer) {
  ...
  const ubcCardVerticalTwo = writer.createElement('ubcCardVerticalTwo');
  ...
  const firstImage = writer.createElement('ubcCardVerticalTwoImage', { class: 'first-image' });
  const firstImagePlaceholder = writer.createElement( 'imageInline', { src: 'https://placehold.co/700x350' } );
  const firstContent = writer.createElement('ubcCardVerticalTwoContent', { class: 'first-content' });
  ...
  const firstFooter = writer.createElement('ubcCardVerticalTwoFooter', { class: 'first-footer' });
  ...
  const secondImage = writer.createElement('ubcCardVerticalTwoImage', { class: 'second-image' });
  const secondImagePlaceholder = writer.createElement( 'imageInline', { src: 'https://placehold.co/700x350' } );
  const secondContent = writer.createElement('ubcCardVerticalTwoContent', { class: 'second-content' });
  ...
  const secondFooter = writer.createElement('ubcCardVerticalTwoFooter', { class: 'second-footer' });
