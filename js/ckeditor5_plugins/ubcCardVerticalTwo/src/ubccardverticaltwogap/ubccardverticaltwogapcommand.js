/**
 * @file defines UbcCardVerticalTwoGapCommand.
 */
 ...
 */
export default class UbcCardVerticalTwoGapCommand extends Command {
  /**
   * Creates a new `UbcCardVerticalTwoGapCommand` instance.
   *
