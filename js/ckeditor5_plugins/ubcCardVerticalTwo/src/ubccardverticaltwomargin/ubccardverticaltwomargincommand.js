/**
 * @file defines UbcCardVerticalTwoMarginCommand.
 */
 ...
 */
export default class UbcCardVerticalTwoMarginCommand extends Command {
  /**
   * Creates a new `UbcCardVerticalTwoMarginCommand` instance.
   *
  ...
  execute(options = {}) {
    ...
    // Is the command triggered from the `ubcCardVerticalTwo`?
