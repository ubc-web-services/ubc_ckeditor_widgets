...
import UbcCardVerticalTwoMarginCommand from './ubccardverticaltwomargincommand';

export default class UbcCardVerticalTwoMarginEditing extends Plugin {
  static get requires() {
    return [Widget];
  }

  static get pluginName() {
    return 'UbcCardVerticalTwoMarginEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcCardVerticalTwoMarginCommand(editor)
    );
  }
