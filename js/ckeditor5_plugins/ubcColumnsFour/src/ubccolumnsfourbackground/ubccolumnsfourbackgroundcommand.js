/**
 * @file defines UbcColumnsFourBackgroundCommand.
 */
 ...
 */
export default class UbcColumnsFourBackgroundCommand extends Command {
  /**
   * Creates a new `UbcColumnsFourBackgroundCommand` instance.
   *
