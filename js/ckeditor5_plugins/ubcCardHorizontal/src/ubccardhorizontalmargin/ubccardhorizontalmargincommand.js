/**
 * @file defines UbcCardHorizontalMarginCommand.
 */
 ...
 */
export default class UbcCardHorizontalMarginCommand extends Command {
  /**
   * Creates a new `UbcCardHorizontalMarginCommand` instance.
   *
