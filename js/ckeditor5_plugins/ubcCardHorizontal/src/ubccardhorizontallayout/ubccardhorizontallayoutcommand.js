/**
 * @file defines UbcCardHorizontalLayoutCommand.
 */
 ...
 */
export default class UbcCardHorizontalLayoutCommand extends Command {
  /**
   * Creates a new `UbcCardHorizontalLayoutCommand` instance.
   *
