...
import UbcCardHorizontalBackgroundCommand from './ubccardhorizontalbackgroundcommand';

export default class UbcCardHorizontalBackgroundEditing extends Plugin {
  ...
  static get pluginName() {
    return 'UbcCardHorizontalBackgroundEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcCardHorizontalBackgroundCommand(editor)
    );
  }
