...
export default class UbcCardHorizontalBackgroundUI extends Plugin {

  /**
   * @inheritDoc
   */
  static get pluginName() {
    return 'UbcCardHorizontalBackgroundUI';
  }
  ...
  init() {
    ...
    const command = editor.commands.get('ubcCardHorizontalBackground');

    editor.ui.componentFactory.add('ubcCardHorizontalBackgroundOptions', locale => {
...
function _prepareListOptions(options, command) {
  ...
  const activecommand = 'ubcCardHorizontalBackground';
  let alloptions = backgroundStyles.map(style => {
    return style;
  });
