...
import UbcCardHorizontalShadowCommand from './ubccardhorizontalshadowcommand';

export default class UbcCardHorizontalShadowEditing extends Plugin {
  ...
  static get pluginName() {
    return 'UbcCardHorizontalShadowEditing';
  }
  ...
  init() {
    ...
    editor.commands.add(
      ...
      new UbcCardHorizontalShadowCommand(editor)
    );
  }
