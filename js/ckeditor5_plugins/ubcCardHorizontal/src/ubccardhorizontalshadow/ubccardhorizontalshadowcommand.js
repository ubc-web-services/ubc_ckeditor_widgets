/**
 * @file defines UbcCardHorizontalShadowCommand.
 */
 ...
 */
export default class UbcCardHorizontalShadowCommand extends Command {
  /**
   * Creates a new `UbcCardHorizontalShadowCommand` instance.
   *
