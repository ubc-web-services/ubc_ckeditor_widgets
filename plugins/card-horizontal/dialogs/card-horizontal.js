CKEDITOR.dialog.add('card-horizontal', function (editor) {
  return {
    ...
    contents: [{
      ...
      elements: [
      {
        ...
        },
        {
          ...
          items: [
            ['Text region right', ''],
            ['Text region left', 'widget-card--reverse']
          ],
          setup: function (widget) {
            this.setValue(widget.data.direction);
          },
          commit: function (widget) {
            widget.setData('direction', this.getValue());
          }
        }
      ]
    }]
