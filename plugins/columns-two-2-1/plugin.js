  ...
  CKEDITOR.plugins.add('flex-2columns-2-1', {
    ...
    init: function (editor) {
      ...
      editor.widgets.add('flex-2columns-2-1', {
        template: '<div class="widget-columns--2-1 flex-grid">' +
          '<div class="flex-2"><p>First Column</p></div>' +
          '<div class="flex-1"><p>Second Column</p></div>' +
          '</div>',
        allowedContent: 'div(!widget-columns--2-1,!flex-grid);' +
          'div(!flex-2);' +
          'div(!flex-1);',
        // Minimum HTML which is required by this widget to work.
        requiredContent: 'div(widget-columns--2-1)',
        editables: {
          col1: {
            selector: 'div.widget-columns--2-1 > div:nth-child(1)',
          },
          col2: {
            selector: 'div.widget-columns--2-1 > div:nth-child(2)',
          }
        },
        upcast: function (element) {
          return element.name == 'div' && element.hasClass('widget-columns--2-1');
        }
      });
    }
  });
